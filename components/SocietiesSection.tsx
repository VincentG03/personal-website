        ...
        <div className="grid md:grid-cols-2 gap-6">
          {societies.map((society, index) => (
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm p-6 rounded-xl border border-gray-700 transition-all duration-300"
            >
            ...
            <div className="flex gap-6 min-w-max">
              {competitions.map((competition, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-700 transition-all duration-300 w-[280px] flex-shrink-0"
                >
