...
const experiences = [
  {
    ...
    highlights: ['Reduced load time by 60%', 'Led team of 5 engineers', 'Implemented CI/CD pipeline'],
  },
  {
    ...
    highlights: ['Built 10+ production apps', 'Improved code quality metrics', 'Integrated payment systems'],
  },
  {
    role: 'Software Developer',
    company: 'StartUp Ventures',
    period: '2018 - 2020',
    description: 'Contributed to the development of the core product platform. Worked closely with product team to implement new features.',
    highlights: ['Launched MVP in 3 months', 'Reduced bug count by 40%', 'Implemented testing suite'],
  },
];
      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="relative">
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-8 md:left-1/2 top-6 w-4 h-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full -translate-x-1/2 ring-4 ring-gray-900" />
        ...
        <motion.div
          ...
          className="mt-20 text-center py-12 border-t border-gray-800"
        >
