        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            ...
            >
              {/* Single role company */}
              {exp.role && (
                <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-gray-700 transition-all duration-300">
                      ...
                      {exp.roles.length > 1 && (
                        <div className="space-y-4 mt-6">
                          {exp.roles.slice(1).map((role, roleIndex) => (
                            <div 
                              key={roleIndex}
                              className="pl-6 border-l-2 border-[#e879f9]"
                            >
